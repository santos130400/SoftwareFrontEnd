...
public class UpdateEmpresa extends javax.swing.JFrame implements ActionListener, KeyListener {
    ...
    public UpdateEmpresa(MenuEmpresa ppal, String key) {
        initComponents();
    ...
    private void llenarCampos(){
        ...
        this.jTextField2.setText(valores[4]);
        this.jTextField3.setText(valores[3]);
        this.jTextField4.setText(valores[0]);
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        if (evento.getSource() == this.jButton4) {
            if(jTextField2.getText().equals("") || jTextField3.getText().equals("") || jTextField4.getText().equals("") || (String.valueOf(jPasswordField1.getPassword())).equals("")){
                ...
                if(opcion==0){
                    ...
                    Start e = new Start();
                    try {
                        InputStream response = new URL("http://localhost:8080/api/updateEmpresa/"+valores[0]+"/"+login+"/"+password+"/"+NIT+"/"+nombre+"/"+direccion+"/"+this.key).openStream();
