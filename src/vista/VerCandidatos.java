...
public class VerCandidatos extends javax.swing.JFrame implements ActionListener{

    private MenuEmpresa ppal;
    private String candidatos;

    public VerCandidatos(MenuEmpresa ppal) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Ver Candidatos");
    ...
    private void llenarCampos() {
        try {
            InputStream response = new URL("http://localhost:8080/api/getAllTrabajadores").openStream();
            this.candidatos= IOUtils.toString(response, "UTF-8");
            System.out.println(this.candidatos);
            response.close();
        }
        catch (IOException e){
            e.printStackTrace();
        ...
        this.jTextArea1.setText(this.candidatos);
    }
