...
public class MisOfertas extends javax.swing.JFrame implements ActionListener{
    ...
    public MisOfertas(MenuEmpresa ppal, String login) {
        initComponents();
        ...
        try {
            InputStream response = new URL("http://localhost:8080/api/readEmpresalogin/"+this.login).openStream();
    ...
    private void llenarCampos() {
        this.jTextArea1.setText(valores[5]);
    }
