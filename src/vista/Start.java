...
public class Start extends javax.swing.JFrame implements ActionListener {
    ...
    private void initComponents() {
        ...
        jLabel6.setFont(new java.awt.Font("Engravers MT", 0, 30)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("DESGENERORIZAR");

        jLabel7.setFont(new java.awt.Font("Amore Mio Personal Use", 0, 24)); // NOI18N

        jLabel8.setFont(new java.awt.Font("Baskerville Old Face", 0, 24)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Bienvenide a");
        ...
        jButton2.setBackground(new java.awt.Color(19, 94, 163));
    ...
    public void actionPerformed(ActionEvent evento) {
        if (evento.getSource() == this.jButton1) {
            ...
            IniciarSesion e = new IniciarSesion(this);
        }
        
        if (evento.getSource() == this.jButton2) {
            this.setVisible(false);
            Registrarse e = new Registrarse(this);
        }
