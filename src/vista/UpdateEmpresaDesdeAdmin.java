...
public class UpdateEmpresaDesdeAdmin extends javax.swing.JFrame implements ActionListener, KeyListener {
    ...
    private void llenarCampos(String[] valores){
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        if (evento.getSource() == this.jButton1) {
            ...
            try {
                InputStream response = new URL("http://localhost:8080/api/readEmpresalogin/"+login).openStream();
            ...
            if(empresa!=null){
                this.llenarCampos(this.valores);
            }else{
